...
/***/ function(module, exports, __webpack_require__) {
	...
	var Watch = __webpack_require__(166);
	
	document.addEventListener("DOMContentLoaded", function () {
	  ReactDOM.render(React.createElement(Watch, null), document.getElementById('main'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ReactDOM = __webpack_require__(32);
	var Display = __webpack_require__(167);
	var Buttons = __webpack_require__(168);
	var Splits = __webpack_require__(169);
	...
	module.exports = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(Buttons, { button1cb: this.button1click, button2cb: this.button2click, running: this.state.running }),
	...
	module.exports = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'button',
	        { onClick: this.props.button1cb },
	        button1text
	      ),
	      React.createElement(
	        'button',
	        { onClick: this.props.button2cb },
	        button2text
	      )
	    );
	  }
